const CardPerfilU = ({ userData }) => {
  const { nombre, apellido, cedula, email, telefono } = userData;

  return (
    <div className="mx-auto bg-white rounded-xl border-4 border-azul-10 border-dashed overflow-hidden">
